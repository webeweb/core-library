 ...
 * @final
 */
final class ObjectArgumentException extends IllegalArgumentException {
    ...
    public function __construct($argument, Exception $previous = null) {
        parent::__construct(sprintf("The argument \"%s\" is not an object", print_r($argument, true)), $previous);
    }
