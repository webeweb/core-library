...
interface HTTPCodeInterface {
    ...
    const CODES = [
        ...
        self::CODE_RETRY_WITH,
        self::CODE_BLOCKED_BY_WINDOWS_PARENTAL_CONTROLS,
        self::CODE_UNAVAILABLE_FOR_LEGAL_REASONS,
        self::CODE_UNRECOVERABLE_ERROR,
        self::CODE_NO_RESPONSE,
        self::CODE_SSL_CERTIFICATE_ERROR,
        self::CODE_SSL_CERTIFICATE_REQUIRED,
        self::CODE_HTTP_REQUEST_SENT_TO_HTTPS_PORT,
        self::CODE_CLIENT_CLOSED_REQUEST,
        ...
        self::CODE_WEB_SERVER_IS_DOWN,
        self::CODE_CONNECTION_TIMED_OUT,
        self::CODE_ORIGIN_IS_UNREACHABLE,
        self::CODE_A_TIMEOUT_OCCURRED,
        self::CODE_SSL_HANDSHAKE_FAILED,
        self::CODE_INVALID_SSL_CERTIFICATE,
        self::CODE_RAILGUN_ERROR,
    ];
