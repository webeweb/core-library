...
final class FormRendererTest extends PHPUnit_Framework_TestCase {
    ...
    public function testRender() {
        ...
        $obj[5]->expects($this->any())->method("getTranslatedChoiceLabel")->willReturn("translatedChoiceLabel");
        ...
        $this->assertEquals("translatedChoiceLabel", FormRenderer::render($obj[5]));
