...
/**
 * GET price list supplier products site request.
 *
 * @author webeweb <https://github.com/webeweb>
 * @package WBW\Library\Easilys\Request\Products
 */
class GetPriceListSupplierProductsSiteRequest extends AbstractRequest implements SubstituableRequestInterface {
    ...
    public function deserializeResponse(string $rawResponse): AbstractResponse {
        return ResponseDeserializer::deserializeGetPriceListSupplierProductsSiteResponse($rawResponse);
    }
