 ...
 */
class GetProductsSiteRequest extends AbstractRequest implements SubstituableRequestInterface {
    ...
    public function deserializeResponse(string $rawResponse): AbstractResponse {
        return ResponseDeserializer::deserializeGetProductsSiteResponse($rawResponse);
    }
