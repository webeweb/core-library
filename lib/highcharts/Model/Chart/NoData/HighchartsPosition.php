...
namespace WBW\Library\Highcharts\Model\Chart\NoData;
 ...
 * @package WBW\Library\Highcharts\Model\Chart\NoData
 * @version 5.0.14
 */
class HighchartsPosition implements JsonSerializable {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\NoData\HighchartsPosition Returns this highcharts position.
     */
    public function setAlign(?string $align): \WBW\Library\Highcharts\Model\Chart\NoData\HighchartsPosition {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\NoData\HighchartsPosition Returns this highcharts position.
     */
    public function setVerticalAlign(?string $verticalAlign): \WBW\Library\Highcharts\Model\Chart\NoData\HighchartsPosition {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\NoData\HighchartsPosition Returns this highcharts position.
     */
    public function setX(?float $x): \WBW\Library\Highcharts\Model\Chart\NoData\HighchartsPosition {
        $this->x = $x;
        return $this;
    }
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\NoData\HighchartsPosition Returns this highcharts position.
     */
    public function setY(?float $y): \WBW\Library\Highcharts\Model\Chart\NoData\HighchartsPosition {
        $this->y = $y;
        return $this;
    }
}
