...
namespace WBW\Library\Highcharts\Model\Chart\Series\Column\Data;
 ...
 * @package WBW\Library\Highcharts\Model\Chart\Series\Column\Data
 * @version 5.0.14
 */
class HighchartsEvents implements JsonSerializable {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents Returns this highcharts events.
     */
    public function setClick(?string $click): \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents {
        $this->click = $click;
        return $this;
    }
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents Returns this highcharts events.
     */
    public function setMouseOut(?string $mouseOut): \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents Returns this highcharts events.
     */
    public function setMouseOver(?string $mouseOver): \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents Returns this highcharts events.
     */
    public function setRemove(?string $remove): \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents {
        $this->remove = $remove;
        return $this;
    }
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents Returns this highcharts events.
     */
    public function setSelect(?string $select): \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents {
        $this->select = $select;
        return $this;
    }
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents Returns this highcharts events.
     */
    public function setUnselect(?string $unselect): \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents Returns this highcharts events.
     */
    public function setUpdate(?string $update): \WBW\Library\Highcharts\Model\Chart\Series\Column\Data\HighchartsEvents {
        $this->update = $update;
        return $this;
    }
}
