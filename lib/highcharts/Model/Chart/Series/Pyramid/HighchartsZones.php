...
class HighchartsZones implements JsonSerializable {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsZones Returns this highcharts zones.
     */
    public function setClassName(?string $className): \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsZones {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsZones Returns this highcharts zones.
     */
    public function setColor(?string $color): \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsZones {
        $this->color = $color;
        return $this;
    }
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsZones Returns this highcharts zones.
     */
    public function setDashStyle(?string $dashStyle): \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsZones {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsZones Returns this highcharts zones.
     */
    public function setFillColor(?string $fillColor): \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsZones {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsZones Returns this highcharts zones.
     */
    public function setValue(?float $value): \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsZones {
        $this->value = $value;
        return $this;
    }
}
