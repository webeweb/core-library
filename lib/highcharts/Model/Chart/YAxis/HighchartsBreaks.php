...
class HighchartsBreaks implements JsonSerializable {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\YAxis\HighchartsBreaks Returns this highcharts breaks.
     */
    public function setBreakSize(?float $breakSize): \WBW\Library\Highcharts\Model\Chart\YAxis\HighchartsBreaks {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\YAxis\HighchartsBreaks Returns this highcharts breaks.
     */
    public function setFrom(?float $from): \WBW\Library\Highcharts\Model\Chart\YAxis\HighchartsBreaks {
        $this->from = $from;
        return $this;
    }
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\YAxis\HighchartsBreaks Returns this highcharts breaks.
     */
    public function setRepeat(?float $repeat): \WBW\Library\Highcharts\Model\Chart\YAxis\HighchartsBreaks {
        $this->repeat = $repeat;
        return $this;
    }
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\YAxis\HighchartsBreaks Returns this highcharts breaks.
     */
    public function setTo(?float $to): \WBW\Library\Highcharts\Model\Chart\YAxis\HighchartsBreaks {
        $this->to = $to;
        return $this;
    }
}
