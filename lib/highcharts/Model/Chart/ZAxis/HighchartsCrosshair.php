...
class HighchartsCrosshair implements JsonSerializable {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair Returns this highcharts crosshair.
     */
    public function setClassName(?string $className): \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair Returns this highcharts crosshair.
     */
    public function setColor(?string $color): \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair {
        $this->color = $color;
        return $this;
    }
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair Returns this highcharts crosshair.
     */
    public function setDashStyle(?string $dashStyle): \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair {
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair Returns this highcharts crosshair.
     */
    public function setSnap(?bool $snap): \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair {
        $this->snap = $snap;
        return $this;
    }
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair Returns this highcharts crosshair.
     */
    public function setWidth(?float $width): \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair {
        $this->width = $width;
        return $this;
    }
     ...
     * @return \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair Returns this highcharts crosshair.
     */
    public function setZIndex(?float $zIndex): \WBW\Library\Highcharts\Model\Chart\ZAxis\HighchartsCrosshair {
        $this->zIndex = $zIndex;
        return $this;
    }
}
