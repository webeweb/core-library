...
namespace WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Area;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Area
 * @version 5.0.14
 */
class HighchartsDataLabelsTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["align" => "right", "allowOverlap" => false, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 47.0, "borderWidth" => 9.0, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "crop" => true, "defer" => true, "enabled" => false, "format" => "1ddcb92ade31c8fbd370001f9b29a7d9", "formatter" => "f2ffc59487832cbad265a8fef2133592", "inside" => false, "overflow" => "none", "padding" => 95.0, "rotation" => 14.0, "shadow" => "3bf1114a986ba87ed28fc1b5884fc2f8", "shape" => "8c73a98a300905900337f535531dfca6", "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "useHTML" => false, "verticalAlign" => "bottom", "x" => 65.0, "y" => 49.0, "zIndex" => 61.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Area\HighchartsDataLabels();
        $obj->setAlign("right");
        $obj->setAllowOverlap(false);
        $obj->setBackgroundColor("930f2a43179a7ae5fc25ed873223e99f");
        $obj->setBorderColor("97da935a74593c55d78be9d1295aa994");
        $obj->setBorderRadius(47.0);
        $obj->setBorderWidth(9.0);
    ...
    public function testSetBorderRadius(): void {
        ...
        $obj->setBorderRadius(21.0);
        $this->assertEquals(21.0, $obj->getBorderRadius());
    }
    ...
    public function testSetPadding(): void {
        ...
        $obj->setPadding(49.0);
        $this->assertEquals(49.0, $obj->getPadding());
    }
    ...
    public function testSetRotation(): void {
        ...
        $obj->setRotation(23.0);
        $this->assertEquals(23.0, $obj->getRotation());
    }
    ...
    public function testSetZIndex(): void {
        ...
        $obj->setZIndex(81.0);
        $this->assertEquals(81.0, $obj->getZIndex());
    }
