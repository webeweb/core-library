...
class HighchartsTooltipTest extends AbstractTestCase {
    ...
    public function testSetHideDelay(): void {
        ...
        $obj->setHideDelay(67.0);
        $this->assertEquals(67.0, $obj->getHideDelay());
    }
    ...
    public function testSetPadding(): void {
        ...
        $obj->setPadding(42.0);
        $this->assertEquals(42.0, $obj->getPadding());
    }
    ...
    public function testSetValueDecimals(): void {
        ...
        $obj->setValueDecimals(29.0);
        $this->assertEquals(29.0, $obj->getValueDecimals());
    }
