...
namespace WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Area\Marker\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Area\Marker\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 37.0, "lineWidthPlus" => 67.0, "radius" => 36.0, "radiusPlus" => 18.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Area\Marker\States\HighchartsHover();
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $this->assertEquals(89.0, $obj->getLineWidthPlus());
    }
    ...
    public function testSetRadiusPlus(): void {
        ...
        $obj->setRadiusPlus(5.0);
        $this->assertEquals(5.0, $obj->getRadiusPlus());
    }
