...
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 44.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 36.0, "radius" => 13.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 23.0];
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(9.0);
        $this->assertEquals(9.0, $obj->getRadius());
    }
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(17.0);
        $this->assertEquals(17.0, $obj->getWidth());
    }
