...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 11.0, "size" => 33.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Areaspline\States\Hover\HighchartsHalo();
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(81.0);
        $this->assertEquals(81.0, $obj->getOpacity());
    }
