...
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 3.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 37.0, "radius" => 68.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 4.0];
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(24.0);
        $this->assertEquals(24.0, $obj->getHeight());
    }
