...
namespace WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Areasplinerange\States\Hover;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Areasplinerange\States\Hover
 * @version 5.0.14
 */
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 6.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 35.0, "radius" => 30.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 34.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Areasplinerange\States\Hover\HighchartsMarker();
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(51.0);
        $this->assertEquals(51.0, $obj->getHeight());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(29.0);
        $this->assertEquals(29.0, $obj->getRadius());
    }
