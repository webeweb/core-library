...
namespace WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Bar\States\Hover;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Bar\States\Hover
 * @version 5.0.14
 */
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 52.0, "size" => 12.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Bar\States\Hover\HighchartsHalo();
    ...
    public function testSetSize(): void {
        ...
        $obj->setSize(94.0);
        $this->assertEquals(94.0, $obj->getSize());
    }
