...
namespace WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Boxplot;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Boxplot
 * @version 5.0.14
 */
class HighchartsTooltipTest extends AbstractTestCase {
    ...
    public function testSetHideDelay(): void {
        ...
        $obj->setHideDelay(93.0);
        $this->assertEquals(93.0, $obj->getHideDelay());
    }
    ...
    public function testSetPadding(): void {
        ...
        $obj->setPadding(90.0);
        $this->assertEquals(90.0, $obj->getPadding());
    }
    ...
    public function testSetValueDecimals(): void {
        ...
        $obj->setValueDecimals(18.0);
        $this->assertEquals(18.0, $obj->getValueDecimals());
    }
