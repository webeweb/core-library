...
class HighchartsSelectTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 25.0, "radius" => 40.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Bubble\Marker\States\HighchartsSelect();
