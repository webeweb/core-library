...
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 0.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 88.0, "radius" => 74.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 31.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Bubble\States\Hover\HighchartsMarker();
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(23.0);
        $this->assertEquals(23.0, $obj->getRadius());
    }
