...
namespace WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Errorbar\States\Hover;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Errorbar\States\Hover
 * @version 5.0.14
 */
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 82.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 37.0, "radius" => 54.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 11.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Errorbar\States\Hover\HighchartsMarker();
        $obj->setEnabled(true);
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(42.0);
        $this->assertEquals(42.0, $obj->getRadius());
    }
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(47.0);
        $this->assertEquals(47.0, $obj->getWidth());
    }
