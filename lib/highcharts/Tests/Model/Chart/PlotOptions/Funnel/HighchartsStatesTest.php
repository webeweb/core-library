...
class HighchartsStatesTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $hover = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Funnel\States\HighchartsHover();

        $exp = ["hover" => $hover->jsonSerialize()];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Funnel\HighchartsStates();
        $obj->setHover($hover);
    ...
    public function testNewHover(): void {
        ...
        $res = $obj->newHover();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\PlotOptions\Funnel\States\HighchartsHover::class, $res);
    }
    ...
    public function testSetHover(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\PlotOptions\Funnel\States\HighchartsHover mock.
        $hover = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Funnel\States\HighchartsHover();
