...
class HighchartsTooltipTest extends AbstractTestCase {
    ...
    public function testSetHideDelay(): void {
        ...
        $obj->setHideDelay(100.0);
        $this->assertEquals(100.0, $obj->getHideDelay());
    }
    ...
    public function testSetPadding(): void {
        ...
        $obj->setPadding(13.0);
        $this->assertEquals(13.0, $obj->getPadding());
    }
    ...
    public function testSetValueDecimals(): void {
        ...
        $obj->setValueDecimals(43.0);
        $this->assertEquals(43.0, $obj->getValueDecimals());
    }
