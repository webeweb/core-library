...
class HighchartsDataLabelsTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["align" => "right", "allowOverlap" => false, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 89.0, "borderWidth" => 67.0, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "crop" => false, "defer" => false, "enabled" => true, "format" => "1ddcb92ade31c8fbd370001f9b29a7d9", "formatter" => "f2ffc59487832cbad265a8fef2133592", "inside" => true, "overflow" => "none", "padding" => 7.0, "rotation" => 58.0, "shadow" => "3bf1114a986ba87ed28fc1b5884fc2f8", "shape" => "8c73a98a300905900337f535531dfca6", "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "useHTML" => true, "verticalAlign" => "bottom", "x" => 65.0, "y" => 98.0, "zIndex" => 51.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Line\HighchartsDataLabels();
        $obj->setAlign("right");
    ...
    public function testSetBorderRadius(): void {
        ...
        $this->assertEquals(99.0, $obj->getBorderRadius());
    }
    ...
    public function testSetX(): void {
        ...
        $obj->setX(45.0);
        $this->assertEquals(45.0, $obj->getX());
    }
    ...
    public function testSetY(): void {
        ...
        $obj->setY(85.0);
        $this->assertEquals(85.0, $obj->getY());
    }
    ...
    public function testSetZIndex(): void {
        ...
        $obj->setZIndex(65.0);
        $this->assertEquals(65.0, $obj->getZIndex());
    }
