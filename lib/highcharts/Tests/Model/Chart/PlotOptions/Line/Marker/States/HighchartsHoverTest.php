...
namespace WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Line\Marker\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Line\Marker\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 83.0, "lineWidthPlus" => 28.0, "radius" => 96.0, "radiusPlus" => 27.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Line\Marker\States\HighchartsHover();
        $obj->setEnabled(true);
        $obj->setFillColor("1fde055d3ff900e04ca08bc82066d7fd");
        $obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");
        $obj->setLineWidth(83.0);
        $obj->setLineWidthPlus(28.0);
        $obj->setRadius(96.0);
        $obj->setRadiusPlus(27.0);
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $obj->setLineWidthPlus(43.0);
        $this->assertEquals(43.0, $obj->getLineWidthPlus());
    }
