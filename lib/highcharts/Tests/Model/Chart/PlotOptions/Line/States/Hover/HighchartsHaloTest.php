...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 12.0, "size" => 33.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Line\States\Hover\HighchartsHalo();
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(13.0);
        $this->assertEquals(13.0, $obj->getOpacity());
    }
    ...
    public function testSetSize(): void {
        ...
        $obj->setSize(80.0);
        $this->assertEquals(80.0, $obj->getSize());
    }
