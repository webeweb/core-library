...
class HighchartsDataLabelsTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["align" => "right", "allowOverlap" => false, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 6.0, "borderWidth" => 18.0, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "crop" => true, "defer" => false, "enabled" => true, "format" => "1ddcb92ade31c8fbd370001f9b29a7d9", "formatter" => "f2ffc59487832cbad265a8fef2133592", "inside" => true, "overflow" => "none", "padding" => 23.0, "rotation" => 45.0, "shadow" => "3bf1114a986ba87ed28fc1b5884fc2f8", "shape" => "8c73a98a300905900337f535531dfca6", "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "useHTML" => true, "verticalAlign" => "bottom", "x" => 64.0, "y" => 30.0, "zIndex" => 13.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Polygon\HighchartsDataLabels();
        $obj->setAlign("right");
    ...
    public function testSetBorderRadius(): void {
        ...
        $this->assertEquals(83.0, $obj->getBorderRadius());
    }
    ...
    public function testSetBorderWidth(): void {
        ...
        $this->assertEquals(21.0, $obj->getBorderWidth());
    }
    ...
    public function testSetPadding(): void {
        ...
        $obj->setPadding(60.0);
        $this->assertEquals(60.0, $obj->getPadding());
    }
    ...
    public function testSetRotation(): void {
        ...
        $obj->setRotation(63.0);
        $this->assertEquals(63.0, $obj->getRotation());
    }
    ...
    public function testSetY(): void {
        ...
        $obj->setY(82.0);
        $this->assertEquals(82.0, $obj->getY());
    }
    ...
    public function testSetZIndex(): void {
        ...
        $obj->setZIndex(68.0);
        $this->assertEquals(68.0, $obj->getZIndex());
    }
