...
class HighchartsTooltipTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "followPointer" => true, "followTouchMove" => false, "footerFormat" => "1ac32e030fc5ef01e703d5419170690e", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "hideDelay" => 59.0, "padding" => 44.0, "pointFormat" => "332dd3de68dc71de0745837cbc13e217", "pointFormatter" => "d0b51d7b9a5189f718d161b366d33044", "split" => false, "valueDecimals" => 23.0, "valuePrefix" => "5fde1c8b25eb2ea19ff8377e62564818", "valueSuffix" => "bf995908ddff004471c953d8062bd1db", "xDateFormat" => "e24debfa0bc8408e1dda05cbd537a072"];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Polygon\HighchartsTooltip();
    ...
    public function testSetHideDelay(): void {
        ...
        $obj->setHideDelay(83.0);
        $this->assertEquals(83.0, $obj->getHideDelay());
    }
    ...
    public function testSetPadding(): void {
        ...
        $obj->setPadding(58.0);
        $this->assertEquals(58.0, $obj->getPadding());
    }
    ...
    public function testSetValueDecimals(): void {
        ...
        $obj->setValueDecimals(75.0);
        $this->assertEquals(75.0, $obj->getValueDecimals());
    }
