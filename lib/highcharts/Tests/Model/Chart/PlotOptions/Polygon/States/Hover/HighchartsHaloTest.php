...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 58.0, "size" => 75.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Polygon\States\Hover\HighchartsHalo();
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(3.0);
        $this->assertEquals(3.0, $obj->getOpacity());
    }
