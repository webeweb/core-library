...
namespace WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Polygon\States\Hover;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Polygon\States\Hover
 * @version 5.0.14
 */
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 100.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 64.0, "radius" => 98.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 46.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Polygon\States\Hover\HighchartsMarker();
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(93.0);
        $this->assertEquals(93.0, $obj->getHeight());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(2.0);
        $this->assertEquals(2.0, $obj->getRadius());
    }
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(92.0);
        $this->assertEquals(92.0, $obj->getWidth());
    }
