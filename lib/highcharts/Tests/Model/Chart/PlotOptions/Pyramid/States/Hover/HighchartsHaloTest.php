...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 84.0, "size" => 80.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Pyramid\States\Hover\HighchartsHalo();
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(59.0);
        $this->assertEquals(59.0, $obj->getOpacity());
    }
