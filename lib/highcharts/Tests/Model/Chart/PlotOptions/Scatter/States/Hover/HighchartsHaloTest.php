...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 85.0, "size" => 99.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Scatter\States\Hover\HighchartsHalo();
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(35.0);
        $this->assertEquals(35.0, $obj->getOpacity());
    }
