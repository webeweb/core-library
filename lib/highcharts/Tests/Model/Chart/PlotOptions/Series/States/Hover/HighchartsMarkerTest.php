...
namespace WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Series\States\Hover;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\PlotOptions\Series\States\Hover
 * @version 5.0.14
 */
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 32.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 18.0, "radius" => 65.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 5.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Series\States\Hover\HighchartsMarker();
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(40.0);
        $this->assertEquals(40.0, $obj->getHeight());
    }
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(79.0);
        $this->assertEquals(79.0, $obj->getWidth());
    }
