...
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 55.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32.0, "radius" => 17.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 77.0];
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(54.0);
        $this->assertEquals(54.0, $obj->getHeight());
    }
    ...
    public function testSetLineWidth(): void {
        ...
        $this->assertEquals(61.0, $obj->getLineWidth());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(51.0);
        $this->assertEquals(51.0, $obj->getRadius());
    }
