...
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 56.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 93.0, "radius" => 24.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 57.0];
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(45.0);
        $this->assertEquals(45.0, $obj->getWidth());
    }
