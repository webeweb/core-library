...
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 82.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 58.0, "radius" => 30.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 5.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\PlotOptions\Waterfall\States\Hover\HighchartsMarker();
        $obj->setEnabled(true);
    ...
    public function testSetLineWidth(): void {
        ...
        $this->assertEquals(44.0, $obj->getLineWidth());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(41.0);
        $this->assertEquals(41.0, $obj->getRadius());
    }
