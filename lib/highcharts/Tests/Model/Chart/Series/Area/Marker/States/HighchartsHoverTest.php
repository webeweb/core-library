...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Area\Marker\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Area\Marker\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 74.0, "lineWidthPlus" => 78.0, "radius" => 55.0, "radiusPlus" => 31.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Area\Marker\States\HighchartsHover();
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $this->assertEquals(97.0, $obj->getLineWidthPlus());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(39.0);
        $this->assertEquals(39.0, $obj->getRadius());
    }
    ...
    public function testSetRadiusPlus(): void {
        ...
        $obj->setRadiusPlus(49.0);
        $this->assertEquals(49.0, $obj->getRadiusPlus());
    }
