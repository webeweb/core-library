...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 93.0, "size" => 33.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Arearange\States\Hover\HighchartsHalo();
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(60.0);
        $this->assertEquals(60.0, $obj->getOpacity());
    }
    ...
    public function testSetSize(): void {
        ...
        $obj->setSize(21.0);
        $this->assertEquals(21.0, $obj->getSize());
    }
