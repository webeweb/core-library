...
class HighchartsDataTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $events = new \WBW\Library\Highcharts\Model\Chart\Series\Areaspline\Data\HighchartsEvents();
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Areaspline\Data\HighchartsMarker();

        $exp = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 13.0, "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "drilldown" => "e3fd48c72943315f737d8a814fda4fd1", "events" => $events->jsonSerialize(), "id" => "b80bb7740288fda1f201890375a60c8f", "labelrank" => 97.0, "marker" => $marker->jsonSerialize(), "name" => "b068931cc450442b63f5b3d276ea4297", "selected" => true, "x" => 69.0, "y" => 9.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Areaspline\HighchartsData();
    ...
    public function testNewEvents(): void {
        ...
        $res = $obj->newEvents();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Areaspline\Data\HighchartsEvents::class, $res);
    }
    ...
    public function testNewMarker(): void {
        ...
        $res = $obj->newMarker();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Areaspline\Data\HighchartsMarker::class, $res);
    }
    ...
    public function testSetEvents(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Areaspline\Data\HighchartsEvents mock.
        $events = new \WBW\Library\Highcharts\Model\Chart\Series\Areaspline\Data\HighchartsEvents();
    ...
    public function testSetLabelrank(): void {
        ...
        $obj->setLabelrank(74.0);
        $this->assertEquals(74.0, $obj->getLabelrank());
    }
    ...
    public function testSetMarker(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Areaspline\Data\HighchartsMarker mock.
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Areaspline\Data\HighchartsMarker();
    ...
    public function testSetY(): void {
        ...
        $obj->setY(49.0);
        $this->assertEquals(49.0, $obj->getY());
    }
