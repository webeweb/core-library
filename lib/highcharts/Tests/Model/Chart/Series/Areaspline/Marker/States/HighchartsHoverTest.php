...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Areaspline\Marker\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Areaspline\Marker\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 33.0, "lineWidthPlus" => 56.0, "radius" => 20.0, "radiusPlus" => 46.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Areaspline\Marker\States\HighchartsHover();
        $obj->setEnabled(true);
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $this->assertEquals(18.0, $obj->getLineWidthPlus());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(69.0);
        $this->assertEquals(69.0, $obj->getRadius());
    }
    ...
    public function testSetRadiusPlus(): void {
        ...
        $obj->setRadiusPlus(99.0);
        $this->assertEquals(99.0, $obj->getRadiusPlus());
    }
