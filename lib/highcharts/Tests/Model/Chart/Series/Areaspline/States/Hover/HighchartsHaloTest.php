...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 66.0, "size" => 83.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Areaspline\States\Hover\HighchartsHalo();
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(38.0);
        $this->assertEquals(38.0, $obj->getOpacity());
    }
    ...
    public function testSetSize(): void {
        ...
        $obj->setSize(64.0);
        $this->assertEquals(64.0, $obj->getSize());
    }
