...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Areasplinerange\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Areasplinerange\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Areasplinerange\States\Hover\HighchartsMarker();

        $exp = ["animation" => "6f1c25ed1523962f1bbf9dee9be5092b", "enabled" => true, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 85.0, "lineWidthPlus" => 34.0, "marker" => $marker->jsonSerialize()];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Areasplinerange\States\HighchartsHover();
    ...
    public function testNewMarker(): void {
        ...
        $res = $obj->newMarker();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Areasplinerange\States\Hover\HighchartsMarker::class, $res);
    }
    ...
    public function testSetLineWidth(): void {
        ...
        $this->assertEquals(24.0, $obj->getLineWidth());
    }
    ...
    public function testSetMarker(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Areasplinerange\States\Hover\HighchartsMarker mock.
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Areasplinerange\States\Hover\HighchartsMarker();
