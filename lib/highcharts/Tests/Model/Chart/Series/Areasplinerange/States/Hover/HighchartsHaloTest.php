...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 86.0, "size" => 86.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Areasplinerange\States\Hover\HighchartsHalo();
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(57.0);
        $this->assertEquals(57.0, $obj->getOpacity());
    }
    ...
    public function testSetSize(): void {
        ...
        $obj->setSize(85.0);
        $this->assertEquals(85.0, $obj->getSize());
    }
