...
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 35.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 87.0, "radius" => 23.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 31.0];
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(34.0);
        $this->assertEquals(34.0, $obj->getHeight());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(96.0);
        $this->assertEquals(96.0, $obj->getRadius());
    }
