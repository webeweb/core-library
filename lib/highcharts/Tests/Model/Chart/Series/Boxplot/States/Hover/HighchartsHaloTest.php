...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 24.0, "size" => 82.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Boxplot\States\Hover\HighchartsHalo();
    ...
    public function testSetSize(): void {
        ...
        $obj->setSize(79.0);
        $this->assertEquals(79.0, $obj->getSize());
    }
