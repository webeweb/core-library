...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Bubble\Marker\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Bubble\Marker\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 60.0, "lineWidthPlus" => 60.0, "radius" => 4.0, "radiusPlus" => 39.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Bubble\Marker\States\HighchartsHover();
        $obj->setEnabled(false);
        $obj->setFillColor("1fde055d3ff900e04ca08bc82066d7fd");
        $obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");
        $obj->setLineWidth(60.0);
        $obj->setLineWidthPlus(60.0);
        $obj->setRadius(4.0);
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $obj->setLineWidthPlus(53.0);
        $this->assertEquals(53.0, $obj->getLineWidthPlus());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(21.0);
        $this->assertEquals(21.0, $obj->getRadius());
    }
    ...
    public function testSetRadiusPlus(): void {
        ...
        $obj->setRadiusPlus(42.0);
        $this->assertEquals(42.0, $obj->getRadiusPlus());
    }
