...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Bubble\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Bubble\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Bubble\States\Hover\HighchartsMarker();

        $exp = ["animation" => "6f1c25ed1523962f1bbf9dee9be5092b", "enabled" => true, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 73.0, "lineWidthPlus" => 84.0, "marker" => $marker->jsonSerialize()];
    ...
    public function testNewMarker(): void {
        ...
        $res = $obj->newMarker();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Bubble\States\Hover\HighchartsMarker::class, $res);
    }
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $obj->setLineWidthPlus(37.0);
        $this->assertEquals(37.0, $obj->getLineWidthPlus());
    }
    ...
    public function testSetMarker(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Bubble\States\Hover\HighchartsMarker mock.
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Bubble\States\Hover\HighchartsMarker();
