...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 65.0, "size" => 7.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Bubble\States\Hover\HighchartsHalo();
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(84.0);
        $this->assertEquals(84.0, $obj->getOpacity());
    }
    ...
    public function testSetSize(): void {
        ...
        $obj->setSize(33.0);
        $this->assertEquals(33.0, $obj->getSize());
    }
