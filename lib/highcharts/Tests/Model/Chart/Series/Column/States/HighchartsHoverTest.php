...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Column\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Column\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Column\States\Hover\HighchartsMarker();

        $exp = ["animation" => "6f1c25ed1523962f1bbf9dee9be5092b", "enabled" => true, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 16.0, "lineWidthPlus" => 77.0, "marker" => $marker->jsonSerialize()];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Column\States\HighchartsHover();
        $obj->setAnimation("6f1c25ed1523962f1bbf9dee9be5092b");
        $obj->setEnabled(true);
        $obj->setHalo(["halo" => "57f842286171094855e51fc3a541c1e2"]);
        $obj->setLineWidth(16.0);
        $obj->setLineWidthPlus(77.0);
    ...
    public function testNewMarker(): void {
        ...
        $res = $obj->newMarker();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Column\States\Hover\HighchartsMarker::class, $res);
    }
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $obj->setLineWidthPlus(29.0);
        $this->assertEquals(29.0, $obj->getLineWidthPlus());
    }
    ...
    public function testSetMarker(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Column\States\Hover\HighchartsMarker mock.
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Column\States\Hover\HighchartsMarker();
