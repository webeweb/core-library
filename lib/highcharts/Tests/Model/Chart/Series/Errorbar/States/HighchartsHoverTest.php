...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Errorbar\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Errorbar\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Errorbar\States\Hover\HighchartsMarker();

        $exp = ["animation" => "6f1c25ed1523962f1bbf9dee9be5092b", "enabled" => true, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 28.0, "lineWidthPlus" => 93.0, "marker" => $marker->jsonSerialize()];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Errorbar\States\HighchartsHover();
        $obj->setAnimation("6f1c25ed1523962f1bbf9dee9be5092b");
        $obj->setEnabled(true);
        $obj->setHalo(["halo" => "57f842286171094855e51fc3a541c1e2"]);
        $obj->setLineWidth(28.0);
        $obj->setLineWidthPlus(93.0);
    ...
    public function testNewMarker(): void {
        ...
        $res = $obj->newMarker();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Errorbar\States\Hover\HighchartsMarker::class, $res);
    }
    ...
    public function testSetLineWidth(): void {
        ...
        $this->assertEquals(35.0, $obj->getLineWidth());
    }
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $obj->setLineWidthPlus(11.0);
        $this->assertEquals(11.0, $obj->getLineWidthPlus());
    }
    ...
    public function testSetMarker(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Errorbar\States\Hover\HighchartsMarker mock.
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Errorbar\States\Hover\HighchartsMarker();
