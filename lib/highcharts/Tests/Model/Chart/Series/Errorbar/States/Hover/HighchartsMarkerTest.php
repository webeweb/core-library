...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Errorbar\States\Hover;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Errorbar\States\Hover
 * @version 5.0.14
 */
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 28.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 91.0, "radius" => 29.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 55.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Errorbar\States\Hover\HighchartsMarker();
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(27.0);
        $this->assertEquals(27.0, $obj->getHeight());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(26.0);
        $this->assertEquals(26.0, $obj->getRadius());
    }
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(73.0);
        $this->assertEquals(73.0, $obj->getWidth());
    }
