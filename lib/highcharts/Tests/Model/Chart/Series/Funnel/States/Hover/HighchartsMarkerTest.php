...
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 12.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 76.0, "radius" => 18.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 30.0];
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(53.0);
        $this->assertEquals(53.0, $obj->getRadius());
    }
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(28.0);
        $this->assertEquals(28.0, $obj->getWidth());
    }
