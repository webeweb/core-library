...
class HighchartsDataTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $events = new \WBW\Library\Highcharts\Model\Chart\Series\Gauge\Data\HighchartsEvents();

        $exp = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 77.0, "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => $events->jsonSerialize(), "id" => "b80bb7740288fda1f201890375a60c8f", "labelrank" => 70.0, "name" => "b068931cc450442b63f5b3d276ea4297", "selected" => false, "y" => 36.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Gauge\HighchartsData();
        $obj->setClassName("6f66e878c62db60568a3487869695820");
        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");
        $obj->setColorIndex(77.0);
        $obj->setDataLabels(["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"]);
        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");
        $obj->setEvents($events);
        $obj->setId("b80bb7740288fda1f201890375a60c8f");
        $obj->setLabelrank(70.0);
    ...
    public function testNewEvents(): void {
        ...
        $res = $obj->newEvents();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Gauge\Data\HighchartsEvents::class, $res);
    }
    ...
    public function testSetEvents(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Gauge\Data\HighchartsEvents mock.
        $events = new \WBW\Library\Highcharts\Model\Chart\Series\Gauge\Data\HighchartsEvents();
    ...
    public function testSetLabelrank(): void {
        ...
        $obj->setLabelrank(16.0);
        $this->assertEquals(16.0, $obj->getLabelrank());
    }
    ...
    public function testSetY(): void {
        ...
        $obj->setY(80.0);
        $this->assertEquals(80.0, $obj->getY());
    }
