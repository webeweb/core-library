...
class HighchartsDialTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "baseLength" => "908389f95bb7d5ec0ee86df707120146", "baseWidth" => 44.0, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 0.0, "radius" => "fc021d54683383e5078ab9fefc4d53c8", "rearLength" => "cfeff8818f149d68732253aca8a5c4bf", "topWidth" => 64.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Gauge\HighchartsDial();
        $obj->setBackgroundColor("930f2a43179a7ae5fc25ed873223e99f");
        $obj->setBaseLength("908389f95bb7d5ec0ee86df707120146");
        $obj->setBaseWidth(44.0);
    ...
    public function testSetBaseWidth(): void {
        ...
        $obj->setBaseWidth(89.0);
        $this->assertEquals(89.0, $obj->getBaseWidth());
    }
    ...
    public function testSetTopWidth(): void {
        ...
        $obj->setTopWidth(51.0);
        $this->assertEquals(51.0, $obj->getTopWidth());
    }
