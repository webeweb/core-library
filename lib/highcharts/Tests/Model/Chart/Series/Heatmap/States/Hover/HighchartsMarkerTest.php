...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Heatmap\States\Hover;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Heatmap\States\Hover
 * @version 5.0.14
 */
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 58.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 95.0, "radius" => 73.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 41.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Heatmap\States\Hover\HighchartsMarker();
        $obj->setEnabled(false);
        $obj->setFillColor("1fde055d3ff900e04ca08bc82066d7fd");
        $obj->setHeight(58.0);
        $obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");
        $obj->setLineWidth(95.0);
        $obj->setRadius(73.0);
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(80.0);
        $this->assertEquals(80.0, $obj->getHeight());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(18.0);
        $this->assertEquals(18.0, $obj->getRadius());
    }
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(83.0);
        $this->assertEquals(83.0, $obj->getWidth());
    }
