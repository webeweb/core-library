...
class HighchartsTreemapTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["allowDrillToNode" => true, "allowPointSelect" => false, "alternateStartingDirection" => true, "animation" => true, "animationLimit" => 53.0, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 19.0, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => false, "colorIndex" => 54.0, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => false, "cropThreshold" => 5.0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => $dataLabels->jsonSerialize(), "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => false, "events" => $events->jsonSerialize(), "exposeElementToA11y" => false, "findNearestPointBy" => "xy", "getExtremesFromAll" => true, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => false, "index" => 51.0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "legendIndex" => 54.0, "levelIsConstant" => false, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 9.0, "name" => "b068931cc450442b63f5b3d276ea4297", "opacity" => 14.0, "point" => $point->jsonSerialize(), "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => true, "shadow" => "3bf1114a986ba87ed28fc1b5884fc2f8", "showCheckbox" => false, "showInLegend" => false, "skipKeyboardNavigation" => true, "sortIndex" => 53.0, "states" => $states->jsonSerialize(), "stickyTracking" => true, "tooltip" => $tooltip->jsonSerialize(), "turboThreshold" => 23.0, "type" => "waterfall", "visible" => true, "xAxis" => "b919a806dedef37999b45653bdde66c6", "yAxis" => "f3cd431f5ac1725ea18774e5c02f2889", "zIndex" => 5.0, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
    ...
    public function testSetBorderWidth(): void {
        ...
        $this->assertEquals(80.0, $obj->getBorderWidth());
    }
    ...
    public function testSetColorIndex(): void {
        ...
        $obj->setColorIndex(30.0);
        $this->assertEquals(30.0, $obj->getColorIndex());
    }
    ...
    public function testSetIndex(): void {
        ...
        $obj->setIndex(28.0);
        $this->assertEquals(28.0, $obj->getIndex());
    }
    ...
    public function testSetLegendIndex(): void {
        ...
        $this->assertEquals(90.0, $obj->getLegendIndex());
    }
    ...
    public function testSetMaxPointWidth(): void {
        ...
        $obj->setMaxPointWidth(2.0);
        $this->assertEquals(2.0, $obj->getMaxPointWidth());
    }
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(22.0);
        $this->assertEquals(22.0, $obj->getOpacity());
    }
    ...
    public function testSetSortIndex(): void {
        ...
        $obj->setSortIndex(68.0);
        $this->assertEquals(68.0, $obj->getSortIndex());
    }
    ...
    public function testSetTurboThreshold(): void {
        ...
        $this->assertEquals(31.0, $obj->getTurboThreshold());
    }
    ...
    public function testSetZIndex(): void {
        ...
        $obj->setZIndex(15.0);
        $this->assertEquals(15.0, $obj->getZIndex());
    }
