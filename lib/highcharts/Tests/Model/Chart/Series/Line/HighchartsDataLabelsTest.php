...
class HighchartsDataLabelsTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["align" => "right", "allowOverlap" => true, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 80.0, "borderWidth" => 16.0, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "crop" => false, "defer" => true, "enabled" => true, "format" => "1ddcb92ade31c8fbd370001f9b29a7d9", "formatter" => "f2ffc59487832cbad265a8fef2133592", "inside" => false, "overflow" => "none", "padding" => 40.0, "rotation" => 100.0, "shadow" => "3bf1114a986ba87ed28fc1b5884fc2f8", "shape" => "8c73a98a300905900337f535531dfca6", "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "useHTML" => true, "verticalAlign" => "bottom", "x" => 6.0, "y" => 20.0, "zIndex" => 59.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Line\HighchartsDataLabels();
        $obj->setAlign("right");
    ...
    public function testSetBorderWidth(): void {
        ...
        $obj->setBorderWidth(23.0);
        $this->assertEquals(23.0, $obj->getBorderWidth());
    }
    ...
    public function testSetPadding(): void {
        ...
        $obj->setPadding(95.0);
        $this->assertEquals(95.0, $obj->getPadding());
    }
    ...
    public function testSetRotation(): void {
        ...
        $obj->setRotation(47.0);
        $this->assertEquals(47.0, $obj->getRotation());
    }
    ...
    public function testSetZIndex(): void {
        ...
        $obj->setZIndex(61.0);
        $this->assertEquals(61.0, $obj->getZIndex());
    }
