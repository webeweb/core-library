...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 49.0, "size" => 27.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Line\States\Hover\HighchartsHalo();
    ...
    public function testSetSize(): void {
        ...
        $obj->setSize(59.0);
        $this->assertEquals(59.0, $obj->getSize());
    }
