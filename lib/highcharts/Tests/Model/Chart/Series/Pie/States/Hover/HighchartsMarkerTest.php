...
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 49.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31.0, "radius" => 85.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 81.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Pie\States\Hover\HighchartsMarker();
        $obj->setEnabled(true);
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(18.0);
        $this->assertEquals(18.0, $obj->getHeight());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(44.0);
        $this->assertEquals(44.0, $obj->getRadius());
    }
