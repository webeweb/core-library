...
class HighchartsSelectTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 35.0, "radius" => 23.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Polygon\Data\Marker\States\HighchartsSelect();
        $obj->setEnabled(true);
    ...
    public function testSetLineWidth(): void {
        ...
        $this->assertEquals(20.0, $obj->getLineWidth());
    }
