...
class HighchartsSelectTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 75.0, "radius" => 30.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Polygon\Marker\States\HighchartsSelect();
        $obj->setEnabled(true);
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(60.0);
        $this->assertEquals(60.0, $obj->getRadius());
    }
