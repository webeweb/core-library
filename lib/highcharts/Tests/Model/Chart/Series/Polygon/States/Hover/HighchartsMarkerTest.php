...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Polygon\States\Hover;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Polygon\States\Hover
 * @version 5.0.14
 */
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 80.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 3.0, "radius" => 92.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 66.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Polygon\States\Hover\HighchartsMarker();
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(57.0);
        $this->assertEquals(57.0, $obj->getHeight());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(38.0);
        $this->assertEquals(38.0, $obj->getRadius());
    }
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(12.0);
        $this->assertEquals(12.0, $obj->getWidth());
    }
