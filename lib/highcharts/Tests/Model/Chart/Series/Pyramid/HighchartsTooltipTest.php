...
class HighchartsTooltipTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "followPointer" => false, "followTouchMove" => false, "footerFormat" => "1ac32e030fc5ef01e703d5419170690e", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "hideDelay" => 10.0, "padding" => 12.0, "pointFormat" => "332dd3de68dc71de0745837cbc13e217", "pointFormatter" => "d0b51d7b9a5189f718d161b366d33044", "split" => false, "valueDecimals" => 87.0, "valuePrefix" => "5fde1c8b25eb2ea19ff8377e62564818", "valueSuffix" => "bf995908ddff004471c953d8062bd1db", "xDateFormat" => "e24debfa0bc8408e1dda05cbd537a072"];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\HighchartsTooltip();
    ...
    public function testSetHideDelay(): void {
        ...
        $this->assertEquals(66.0, $obj->getHideDelay());
    }
    ...
    public function testSetPadding(): void {
        ...
        $obj->setPadding(39.0);
        $this->assertEquals(39.0, $obj->getPadding());
    }
    ...
    public function testSetValueDecimals(): void {
        ...
        $obj->setValueDecimals(24.0);
        $this->assertEquals(24.0, $obj->getValueDecimals());
    }
