...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Pyramid\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Pyramid\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\States\Hover\HighchartsMarker();

        $exp = ["animation" => "6f1c25ed1523962f1bbf9dee9be5092b", "enabled" => false, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 99.0, "lineWidthPlus" => 16.0, "marker" => $marker->jsonSerialize()];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\States\HighchartsHover();
    ...
    public function testNewMarker(): void {
        ...
        $res = $obj->newMarker();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Pyramid\States\Hover\HighchartsMarker::class, $res);
    }
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $obj->setLineWidthPlus(23.0);
        $this->assertEquals(23.0, $obj->getLineWidthPlus());
    }
    ...
    public function testSetMarker(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\States\Hover\HighchartsMarker mock.
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\States\Hover\HighchartsMarker();
