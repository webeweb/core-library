...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Pyramid\States\Hover;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Pyramid\States\Hover
 * @version 5.0.14
 */
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 78.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 36.0, "radius" => 36.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 66.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Pyramid\States\Hover\HighchartsMarker();
        $obj->setEnabled(true);
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(91.0);
        $this->assertEquals(91.0, $obj->getHeight());
    }
    ...
    public function testSetLineWidth(): void {
        ...
        $this->assertEquals(15.0, $obj->getLineWidth());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(94.0);
        $this->assertEquals(94.0, $obj->getRadius());
    }
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(0.0);
        $this->assertEquals(0.0, $obj->getWidth());
    }
