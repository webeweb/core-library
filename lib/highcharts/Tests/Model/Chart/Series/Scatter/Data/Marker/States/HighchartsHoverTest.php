...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Scatter\Data\Marker\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Scatter\Data\Marker\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 26.0, "lineWidthPlus" => 47.0, "radius" => 73.0, "radiusPlus" => 53.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Scatter\Data\Marker\States\HighchartsHover();
        $obj->setEnabled(true);
        $obj->setFillColor("1fde055d3ff900e04ca08bc82066d7fd");
        $obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");
        $obj->setLineWidth(26.0);
        $obj->setLineWidthPlus(47.0);
        $obj->setRadius(73.0);
        $obj->setRadiusPlus(53.0);
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(16.0);
        $this->assertEquals(16.0, $obj->getRadius());
    }
    ...
    public function testSetRadiusPlus(): void {
        ...
        $obj->setRadiusPlus(19.0);
        $this->assertEquals(19.0, $obj->getRadiusPlus());
    }
