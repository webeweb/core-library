...
class HighchartsDataLabelsTest extends AbstractTestCase {
    ...
    public function testSetBorderRadius(): void {
        ...
        $this->assertEquals(66.0, $obj->getBorderRadius());
    }
    ...
    public function testSetPadding(): void {
        ...
        $obj->setPadding(26.0);
        $this->assertEquals(26.0, $obj->getPadding());
    }
    ...
    public function testSetRotation(): void {
        ...
        $obj->setRotation(96.0);
        $this->assertEquals(96.0, $obj->getRotation());
    }
    ...
    public function testSetY(): void {
        ...
        $obj->setY(30.0);
        $this->assertEquals(30.0, $obj->getY());
    }
