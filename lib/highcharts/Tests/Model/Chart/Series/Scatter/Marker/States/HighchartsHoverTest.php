...
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 15.0, "lineWidthPlus" => 31.0, "radius" => 98.0, "radiusPlus" => 19.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Scatter\Marker\States\HighchartsHover();
        $obj->setEnabled(false);
        $obj->setFillColor("1fde055d3ff900e04ca08bc82066d7fd");
        $obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");
        $obj->setLineWidth(15.0);
        $obj->setLineWidthPlus(31.0);
        $obj->setRadius(98.0);
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $obj->setLineWidthPlus(30.0);
        $this->assertEquals(30.0, $obj->getLineWidthPlus());
    }
    ...
    public function testSetRadiusPlus(): void {
        ...
        $obj->setRadiusPlus(37.0);
        $this->assertEquals(37.0, $obj->getRadiusPlus());
    }
