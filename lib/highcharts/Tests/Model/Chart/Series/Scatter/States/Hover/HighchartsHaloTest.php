...
class HighchartsHaloTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 70.0, "size" => 15.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Scatter\States\Hover\HighchartsHalo();
    ...
    public function testSetOpacity(): void {
        ...
        $obj->setOpacity(8.0);
        $this->assertEquals(8.0, $obj->getOpacity());
    }
    ...
    public function testSetSize(): void {
        ...
        $obj->setSize(10.0);
        $this->assertEquals(10.0, $obj->getSize());
    }
