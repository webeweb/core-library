...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Spline\Data\Marker\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Spline\Data\Marker\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 92.0, "lineWidthPlus" => 39.0, "radius" => 9.0, "radiusPlus" => 23.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\Data\Marker\States\HighchartsHover();
        $obj->setEnabled(false);
        $obj->setFillColor("1fde055d3ff900e04ca08bc82066d7fd");
        $obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");
        $obj->setLineWidth(92.0);
        $obj->setLineWidthPlus(39.0);
        $obj->setRadius(9.0);
        $obj->setRadiusPlus(23.0);
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $obj->setLineWidthPlus(44.0);
        $this->assertEquals(44.0, $obj->getLineWidthPlus());
    }
    ...
    public function testSetRadiusPlus(): void {
        ...
        $obj->setRadiusPlus(9.0);
        $this->assertEquals(9.0, $obj->getRadiusPlus());
    }
