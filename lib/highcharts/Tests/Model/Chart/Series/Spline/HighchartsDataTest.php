...
class HighchartsDataTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $events = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\Data\HighchartsEvents();
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\Data\HighchartsMarker();

        $exp = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 38.0, "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "drilldown" => "e3fd48c72943315f737d8a814fda4fd1", "events" => $events->jsonSerialize(), "id" => "b80bb7740288fda1f201890375a60c8f", "labelrank" => 43.0, "marker" => $marker->jsonSerialize(), "name" => "b068931cc450442b63f5b3d276ea4297", "selected" => false, "x" => 92.0, "y" => 22.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\HighchartsData();
    ...
    public function testNewEvents(): void {
        ...
        $res = $obj->newEvents();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Spline\Data\HighchartsEvents::class, $res);
    }
    ...
    public function testNewMarker(): void {
        ...
        $res = $obj->newMarker();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Spline\Data\HighchartsMarker::class, $res);
    }
    ...
    public function testSetEvents(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Spline\Data\HighchartsEvents mock.
        $events = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\Data\HighchartsEvents();
    ...
    public function testSetMarker(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Spline\Data\HighchartsMarker mock.
        $marker = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\Data\HighchartsMarker();
    ...
    public function testSetX(): void {
        ...
        $obj->setX(34.0);
        $this->assertEquals(34.0, $obj->getX());
    }
    ...
    public function testSetY(): void {
        ...
        $obj->setY(96.0);
        $this->assertEquals(96.0, $obj->getY());
    }
