...
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $states = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\Marker\HighchartsStates();

        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 23.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 56.0, "radius" => 95.0, "states" => $states->jsonSerialize(), "symbol" => "triangle-down", "width" => 44.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\HighchartsMarker();
    ...
    public function testNewStates(): void {
        ...
        $res = $obj->newStates();
        $this->assertInstanceOf(\WBW\Library\Highcharts\Model\Chart\Series\Spline\Marker\HighchartsStates::class, $res);
    }
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(35.0);
        $this->assertEquals(35.0, $obj->getHeight());
    }
    ...
    public function testSetRadius(): void {
        ...
        $obj->setRadius(71.0);
        $this->assertEquals(71.0, $obj->getRadius());
    }
    ...
    public function testSetStates(): void {
        ...
        // Set a \WBW\Library\Highcharts\Model\Chart\Series\Spline\Marker\HighchartsStates mock.
        $states = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\Marker\HighchartsStates();
    ...
    public function testSetWidth(): void {
        ...
        $obj->setWidth(64.0);
        $this->assertEquals(64.0, $obj->getWidth());
    }
