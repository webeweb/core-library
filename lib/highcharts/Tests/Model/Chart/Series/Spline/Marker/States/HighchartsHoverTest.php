...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Spline\Marker\States;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Spline\Marker\States
 * @version 5.0.14
 */
class HighchartsHoverTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 30.0, "lineWidthPlus" => 39.0, "radius" => 80.0, "radiusPlus" => 48.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\Marker\States\HighchartsHover();
        $obj->setEnabled(true);
    ...
    public function testSetLineWidthPlus(): void {
        ...
        $obj->setLineWidthPlus(13.0);
        $this->assertEquals(13.0, $obj->getLineWidthPlus());
    }
