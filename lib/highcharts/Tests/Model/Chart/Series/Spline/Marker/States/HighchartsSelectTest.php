...
class HighchartsSelectTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => false, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 29.0, "radius" => 85.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Spline\Marker\States\HighchartsSelect();
