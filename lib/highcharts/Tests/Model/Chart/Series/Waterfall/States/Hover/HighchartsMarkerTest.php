...
namespace WBW\Library\Highcharts\Tests\Model\Chart\Series\Waterfall\States\Hover;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\Series\Waterfall\States\Hover
 * @version 5.0.14
 */
class HighchartsMarkerTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["enabled" => true, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 3.0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 96.0, "radius" => 90.0, "states" => "34d955a0df5f7af9c9b4e4dccb3c3564", "symbol" => "triangle-down", "width" => 11.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\Series\Waterfall\States\Hover\HighchartsMarker();
        $obj->setEnabled(true);
    ...
    public function testSetHeight(): void {
        ...
        $obj->setHeight(86.0);
        $this->assertEquals(86.0, $obj->getHeight());
    }
