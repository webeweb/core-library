...
namespace WBW\Library\Highcharts\Tests\Model\Chart\ZAxis\PlotLines;
 ...
 * @package WBW\Library\Highcharts\Tests\Model\Chart\ZAxis\PlotLines
 * @version 5.0.14
 */
class HighchartsLabelTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $exp = ["align" => "f792d1afb0399dce47533bead9d71a8a", "rotation" => 76.0, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "text" => "1cb251ec0d568de6a929b520c4aed8d1", "textAlign" => "6e1fcbf7c065b2e7fef4cdc9bae3fe53", "useHTML" => false, "verticalAlign" => "bottom", "x" => 22.0, "y" => 52.0];

        $obj = new \WBW\Library\Highcharts\Model\Chart\ZAxis\PlotLines\HighchartsLabel();
    ...
    public function testSetX(): void {
        ...
        $obj->setX(74.0);
        $this->assertEquals(74.0, $obj->getX());
    }
    ...
    public function testSetY(): void {
        ...
        $obj->setY(40.0);
        $this->assertEquals(40.0, $obj->getY());
    }
