...
use WBW\Library\Widget\Component\Color\LimeColorInterface as BaseLimeColorInterface;
...
interface LimeColorInterface extends BaseLimeColorInterface {
     ...
     * @var string
     */
    public const LIME_COLOR_VALUE_900 = "#827717";

    /**
     * Lime color value "A100"
     *
     * @var string
     */
