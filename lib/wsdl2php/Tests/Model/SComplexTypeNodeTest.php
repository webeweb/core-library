...
/**
 * s:complexType node test.
 *
 * @author webeweb <https://github.com/webeweb>
 * @package WBW\Library\Wsdl2Php\Tests\Model
 */
class SComplexTypeNodeTest extends AbstractTestCase {
    ...
    public function test__construct(): void {
        ...
        $this->assertEquals("s:complexType", SComplexTypeNode::NODE_NAME);
