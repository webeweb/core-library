...
/**
 * wsdl:binding node test.
 *
 * @author webeweb <https://github.com/webeweb>
 * @package WBW\Library\Wsdl2Php\Tests\Model
 */
class WsdlBindingNodeTest extends AbstractTestCase {
    ...
    public function test__construct(): void {
        ...
        $this->assertEquals("wsdl:binding", WsdlBindingNode::NODE_NAME);
