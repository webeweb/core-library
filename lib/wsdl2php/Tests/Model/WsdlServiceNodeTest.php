...
/**
 * wsdl:service node test.
 *
 * @author webeweb <https://github.com/webeweb>
 * @package WBW\Library\Wsdl2Php\Tests\Model
 */
class WsdlServiceNodeTest extends AbstractTestCase {
    ...
    public function test__construct(): void {
        ...
        $this->assertEquals("wsdl:service", WsdlServiceNode::NODE_NAME);
