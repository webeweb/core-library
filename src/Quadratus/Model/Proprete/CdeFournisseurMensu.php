...
class CdeFournisseurMensu {
     ...
     *
     * @return boolean Returns the from cde type.
     */
     ...
     * Get the prix saisi.
     *
     * @return boolean Returns the prix saisi.
     */
     ...
     *
     * @param boolean $fromCdeType The from cde type.
     * @return CdeFournisseurMensu Returns this cde fournisseur mensu.
     */
     ...
     * Set the prix saisi.
     *
     * @param boolean $prixSaisi The prix saisi.
     * @return CdeFournisseurMensu Returns this cde fournisseur mensu.
     */
