...
class Constantes2 {
     ...
     *
     * @return boolean Returns the format duree.
     */
     ...
     *
     * @return boolean Returns the jours c p a deduire.
     */
     ...
     *
     * @return boolean Returns the publier photo web.
     */
     ...
     *
     * @param boolean $formatDuree The format duree.
     ...
     *
     * @param boolean $joursCPADeduire The jours c p a deduire.
     * @return Constantes2 Returns this constantes2.
     */
     ...
     *
     * @param boolean $publierPhotoWeb The publier photo web.
     * @return Constantes2 Returns this constantes2.
     */
