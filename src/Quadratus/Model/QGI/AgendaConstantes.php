...
class AgendaConstantes {
	 ...
	 *
	 * @return boolean Returns the archivage permanent.
	 */
	 ...
	 *
	 * @return boolean Returns the disabled activity label on first row.
	 */
	...
	/**
	 * Get the dossier fact p m e.
	 *
	 * @return string Returns the dossier fact p m e.
	 */
	 ...
	 *
	 * @return boolean Returns the multi dossiers.
	 */
	 ...
	 *
	 * @return boolean Returns the use new gpe param.
	 */
	 ...
	 *
	 * @param boolean $archivagePermanent The archivage permanent.
	 ...
	 *
	 * @param boolean $disabledActivityLabelOnFirstRow The disabled activity label on first row.
	 * @return AgendaConstantes Returns this agenda constantes.
	 */
	...
	/**
	 * Set the dossier fact p m e.
	 *
	 * @param string $dossierFactPME The dossier fact p m e.
	 * @return AgendaConstantes Returns this agenda constantes.
	 */
	 ...
	 *
	 * @param boolean $multiDossiers The multi dossiers.
	 * @return AgendaConstantes Returns this agenda constantes.
	 */
	 ...
	 *
	 * @param boolean $useNewGpeParam The use new gpe param.
	 * @return AgendaConstantes Returns this agenda constantes.
	 */
