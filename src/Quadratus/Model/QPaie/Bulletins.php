...
class Bulletins {
     ...
     *
     * @return boolean Returns the base s s plaf modif.
     */
     ...
     *
     * @return boolean Returns the borne per modifie.
     */
     ...
     *
     * @return boolean Returns the brutal modifie.
     */
     ...
     *
     * @return boolean Returns the bulletin publie.
     */
     ...
     *
     * @return boolean Returns the cheque edite.
     */
     ...
     *
     * @return boolean Returns the gest calc net paye.
     */
     ...
     *
     * @return boolean Returns the mensuel journalier.
     */
     ...
     *
     * @return boolean Returns the mt j c p arbitrage.
     */
     ...
     *
     * @return boolean Returns the nb j trav force.
     */
     ...
     * Get the p s s30.
     *
     * @return boolean Returns the p s s30.
     */
     ...
     * Get the p s s mod.
     *
     * @return boolean Returns the p s s mod.
     */
     ...
     *
     * @return boolean Returns the paiement c p non pris.
     */
     ...
     *
     * @return boolean Returns the periodicite modifie.
     */
     ...
     *
     * @return boolean Returns the plafond g m p modifie.
     */
     ...
     *
     * @return boolean Returns the type paiment modifie.
     */
     ...
     *
     * @param boolean $baseSSPlafModif The base s s plaf modif.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $bornePerModifie The borne per modifie.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $brutalModifie The brutal modifie.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $bulletinPublie The bulletin publie.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $chequeEdite The cheque edite.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $gestCalcNetPaye The gest calc net paye.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $mensuelJournalier The mensuel journalier.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $mtJCPArbitrage The mt j c p arbitrage.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $nbJTravForce The nb j trav force.
     * @return Bulletins Returns this bulletins.
     */
     ...
     * Set the p s s30.
     *
     * @param boolean $pSS30 The p s s30.
     * @return Bulletins Returns this bulletins.
     */
     ...
     * Set the p s s mod.
     *
     * @param boolean $pSSMod The p s s mod.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $paiementCPNonPris The paiement c p non pris.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $periodiciteModifie The periodicite modifie.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $plafondGMPModifie The plafond g m p modifie.
     * @return Bulletins Returns this bulletins.
     */
     ...
     *
     * @param boolean $typePaimentModifie The type paiment modifie.
     * @return Bulletins Returns this bulletins.
     */
