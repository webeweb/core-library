...
class CommentaireBulletins {
    ...
    /**
     * Get the txt commentaire r t f.
     *
     * @return string Returns the txt commentaire r t f.
     */
    ...
    /**
     * Set the txt commentaire r t f.
     *
     * @param string $txtCommentaireRTF The txt commentaire r t f.
     * @return CommentaireBulletins Returns this commentaire bulletins.
     */
