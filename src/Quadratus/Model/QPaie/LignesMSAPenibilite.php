...
class LignesMSAPenibilite {
     ...
     *
     * @return DateTime Returns the dt deb penibilite.
     */
     ...
     * Get the dt deb per.
     *
     * @return DateTime Returns the dt deb per.
     */
     ...
     *
     * @return DateTime Returns the dt fin penibilite.
     */
     ...
     * Get the dt fin per.
     *
     * @return DateTime Returns the dt fin per.
     */
     ...
     * @return LignesMSAPenibilite Returns this lignes m s a penibilite.
     */
     ...
     *
     * @param DateTime $dtDebPenibilite The dt deb penibilite.
     * @return LignesMSAPenibilite Returns this lignes m s a penibilite.
     */
     ...
     * Set the dt deb per.
     *
     * @param DateTime $dtDebPer The dt deb per.
     * @return LignesMSAPenibilite Returns this lignes m s a penibilite.
     */
     ...
     *
     * @param DateTime $dtFinPenibilite The dt fin penibilite.
     * @return LignesMSAPenibilite Returns this lignes m s a penibilite.
     */
     ...
     * Set the dt fin per.
     *
     * @param DateTime $dtFinPer The dt fin per.
     * @return LignesMSAPenibilite Returns this lignes m s a penibilite.
     */
