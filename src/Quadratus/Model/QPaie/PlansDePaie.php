...
class PlansDePaie {
    ...
    /**
     * Get the type b e n s.
     *
     * @return string Returns the type b e n s.
     */
     ...
     *
     * @return boolean Returns the type commentaire.
     */
    ...
    /**
     * Set the type b e n s.
     *
     * @param string $typeBENS The type b e n s.
     * @return PlansDePaie Returns this plans de paie.
     */
     ...
     *
     * @param boolean $typeCommentaire The type commentaire.
     * @return PlansDePaie Returns this plans de paie.
     */
