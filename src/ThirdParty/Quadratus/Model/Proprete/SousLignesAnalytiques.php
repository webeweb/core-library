...
class SousLignesAnalytiques {
    ...
    /**
     * Get the numero sous ligne cpt h t.
     *
     * @return int Returns the numero sous ligne cpt h t.
     */
    ...
    /**
     * Set the numero sous ligne cpt h t.
     *
     * @param int $numeroSousLigneCptHT The numero sous ligne cpt h t.
     * @return SousLignesAnalytiques Returns this sous lignes analytiques.
     */
