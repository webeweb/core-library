...
use WBW\Library\Core\ThirdParty\Quadratus\Attribute\StringMemo10Trait;
use WBW\Library\Core\ThirdParty\Quadratus\Attribute\StringMemo1Trait;
use WBW\Library\Core\ThirdParty\Quadratus\Attribute\StringMemo2Trait;
use WBW\Library\Core\ThirdParty\Quadratus\Attribute\StringMemo3Trait;
use WBW\Library\Core\ThirdParty\Quadratus\Attribute\StringMemo4Trait;
use WBW\Library\Core\ThirdParty\Quadratus\Attribute\StringMemo5Trait;
use WBW\Library\Core\ThirdParty\Quadratus\Attribute\StringMemo6Trait;
use WBW\Library\Core\ThirdParty\Quadratus\Attribute\StringMemo7Trait;
use WBW\Library\Core\ThirdParty\Quadratus\Attribute\StringMemo8Trait;
use WBW\Library\Core\ThirdParty\Quadratus\Attribute\StringMemo9Trait;
...
class CriteresArticle2 {
    ...
    use StringMemo10Trait;
    use StringMemo2Trait;
    use StringMemo3Trait;
    use StringMemo4Trait;
    use StringMemo5Trait;
    use StringMemo6Trait;
    use StringMemo7Trait;
    use StringMemo8Trait;
    use StringMemo9Trait;
