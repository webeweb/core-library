...
class Tabledeserreurs {
     ...
     *
     * @return bool Returns the cas part s s.
     */
     ...
     * Get the mention c p.
     *
     * @return bool Returns the mention c p.
     */
     ...
     *
     * @return bool Returns the plafond s s30.
     */
     ...
     * Get the regul t d s.
     *
     * @return bool Returns the regul t d s.
     */
     ...
     * Get the t d s107.
     *
     * @return bool Returns the t d s107.
     */
     ...
     * Get the t d s108.
     *
     * @return bool Returns the t d s108.
     */
     ...
     * Get the t d s109.
     *
     * @return bool Returns the t d s109.
     */
     ...
     * Get the t d s110.
     *
     * @return bool Returns the t d s110.
     */
     ...
     * Get the t d s113.
     *
     * @return bool Returns the t d s113.
     */
     ...
     * Get the t d s119.
     *
     * @return bool Returns the t d s119.
     */
     ...
     * Get the t d s120.
     *
     * @return bool Returns the t d s120.
     */
     ...
     * Get the t d s121.
     *
     * @return bool Returns the t d s121.
     */
     ...
     * Get the t d s122.
     *
     * @return bool Returns the t d s122.
     */
     ...
     * Get the t d s78.
     *
     * @return bool Returns the t d s78.
     */
     ...
     *
     * @return bool Returns the travaille j f.
     */
     ...
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     *
     * @param bool $casPartSS The cas part s s.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the mention c p.
     *
     * @param bool $mentionCP The mention c p.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     *
     * @param bool $plafondSS30 The plafond s s30.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the regul t d s.
     *
     * @param bool $regulTDS The regul t d s.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the t d s107.
     *
     * @param bool $tDS107 The t d s107.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the t d s108.
     *
     * @param bool $tDS108 The t d s108.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the t d s109.
     *
     * @param bool $tDS109 The t d s109.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the t d s110.
     *
     * @param bool $tDS110 The t d s110.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the t d s113.
     *
     * @param bool $tDS113 The t d s113.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the t d s119.
     *
     * @param bool $tDS119 The t d s119.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the t d s120.
     *
     * @param bool $tDS120 The t d s120.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the t d s121.
     *
     * @param bool $tDS121 The t d s121.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     * Set the t d s122.
     *
     * @param bool $tDS122 The t d s122.
     * @return Table des erreurs Returns this table des erreurs.
     */
     ...
     *
     * @param bool $travailleJF The travaille j f.
     * @return Table des erreurs Returns this table des erreurs.
     */
