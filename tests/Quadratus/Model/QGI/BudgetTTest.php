...
use DateTime;
use WBW\Library\Core\Quadratus\Model\QGI\BudgetT;
 ...
 * @final
 */
final class BudgetTTest extends AbstractFrameworkTestCase {
	...
	public function testSetDateValid() {
		...
		$obj->setDateValid(new DateTime("2018-09-10"));
		$this->assertEquals(new DateTime("2018-09-10"), $obj->getDateValid());
	}
