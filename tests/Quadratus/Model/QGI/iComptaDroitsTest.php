...
use DateTime;
use WBW\Library\Core\Quadratus\Model\QGI\iComptaDroits;
use WBW\Library\Core\Tests\AbstractFrameworkTestCase;

/**
 * i compta droits model test.
 *
 * @author webeweb <https://github.com/webeweb/>
 * @package WBW\Library\Core\Tests\Quadratus\Model\QGI
 * @final
 */
final class iComptaDroitsTest extends AbstractFrameworkTestCase {
	...
	public function testSetDateLimiteVisu() {
		...
		$obj->setDateLimiteVisu(new DateTime("2018-09-10"));
		$this->assertEquals(new DateTime("2018-09-10"), $obj->getDateLimiteVisu());
	}
	...
	public function testSetPeriodeSaisieDeb() {
		...
		$obj->setPeriodeSaisieDeb(new DateTime("2018-09-10"));
		$this->assertEquals(new DateTime("2018-09-10"), $obj->getPeriodeSaisieDeb());
	}
	...
	public function testSetPeriodeSaisieFin() {
		...
		$obj->setPeriodeSaisieFin(new DateTime("2018-09-10"));
		$this->assertEquals(new DateTime("2018-09-10"), $obj->getPeriodeSaisieFin());
	}
