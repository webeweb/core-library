...
use WBW\Library\Core\Tests\Fixtures\ThirdParty\Quadratus\Attribute\TestDateTimeLettreDeMissionDateSignatureTrait;

/**
 * Lettre de mission_ date signature trait test.
 *
 * @author webeweb <https://github.com/webeweb/>
 * @package WBW\Library\Core\Tests\ThirdParty\Quadratus\Attribute
 */
class DateTimeLettreDeMissionDateSignatureTraitTest extends AbstractTestCase {
    ...
    public function testSetLettreDeMissionDateSignature() {
        ...
        $obj = new TestDateTimeLettreDeMissionDateSignatureTrait();
