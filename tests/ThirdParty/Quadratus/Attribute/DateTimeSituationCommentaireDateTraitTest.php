...
use WBW\Library\Core\Tests\Fixtures\ThirdParty\Quadratus\Attribute\TestDateTimeSituationCommentaireDateTrait;

/**
 * Situation commentaire date trait test.
 *
 * @author webeweb <https://github.com/webeweb/>
 * @package WBW\Library\Core\Tests\ThirdParty\Quadratus\Attribute
 */
class DateTimeSituationCommentaireDateTraitTest extends AbstractTestCase {
    ...
    public function testSetSituationCommentaireDate() {
        ...
        $obj = new TestDateTimeSituationCommentaireDateTrait();
