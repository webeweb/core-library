...
use WBW\Library\Core\Tests\Fixtures\ThirdParty\Quadratus\Attribute\TestStringRetraiteObligatoireTrait;
 ...
 */
class StringRetraiteObligatoireTraitTest extends AbstractTestCase {
    ...
    public function testSetRetraiteObligatoire() {
        ...
        $obj = new TestStringRetraiteObligatoireTrait();
