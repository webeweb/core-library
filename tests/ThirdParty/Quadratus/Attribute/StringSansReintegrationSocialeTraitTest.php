...
use WBW\Library\Core\Tests\Fixtures\ThirdParty\Quadratus\Attribute\TestStringSansReintegrationSocialeTrait;
 ...
 */
class StringSansReintegrationSocialeTraitTest extends AbstractTestCase {
    ...
    public function testSetSansReintegrationSociale() {
        ...
        $obj = new TestStringSansReintegrationSocialeTrait();
