...
/**
 * Emprunts lignes model test.
 *
 * @author webeweb <https://github.com/webeweb/>
 * @package WBW\Library\Core\Tests\ThirdParty\Quadratus\Model\QCompta
 */
class EmpruntsLignesTest extends AbstractFrameworkTestCase {
    ...
    public function testSetDateRemboursement() {
        ...
        $obj->setDateRemboursement(new DateTime("2018-09-10"));
        $this->assertEquals(new DateTime("2018-09-10"), $obj->getDateRemboursement());
    }
