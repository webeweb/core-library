...
class IndigoColorProviderTest extends AbstractTestCase {
    ...
    public function testGetColors(): void {
        ...
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_50, $res[MaterialDesignColorPaletteInterface::COLOR_50]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_100, $res[MaterialDesignColorPaletteInterface::COLOR_100]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_200, $res[MaterialDesignColorPaletteInterface::COLOR_200]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_300, $res[MaterialDesignColorPaletteInterface::COLOR_300]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_400, $res[MaterialDesignColorPaletteInterface::COLOR_400]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_500, $res[MaterialDesignColorPaletteInterface::COLOR_500]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_500, $res[MaterialDesignColorPaletteInterface::COLOR_500]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_600, $res[MaterialDesignColorPaletteInterface::COLOR_600]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_700, $res[MaterialDesignColorPaletteInterface::COLOR_700]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_A100, $res[MaterialDesignColorPaletteInterface::COLOR_A100]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_A200, $res[MaterialDesignColorPaletteInterface::COLOR_A200]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_A400, $res[MaterialDesignColorPaletteInterface::COLOR_A400]);
        $this->assertEquals(IndigoColorProviderInterface::INDIGO_COLOR_A700, $res[MaterialDesignColorPaletteInterface::COLOR_A700]);
    }
    ...
    public function test__construct(): void {
        ...
        $this->assertEquals("wbw.core.assets.color.material_design_color_palette.indigo", IndigoColorProvider::SERVICE_NAME);
