...
class RedColorProviderTest extends AbstractTestCase {
    ...
    public function test__construct(): void {
        ...
        $this->assertEquals("wbw.core.assets.color.material_design_color_palette.red", RedColorProvider::SERVICE_NAME);

        $obj = new RedColorProvider();

        $this->assertInstanceOf(JsonSerializable::class, $obj);
        $this->assertInstanceOf(ColorProviderInterface::class, $obj);
        $this->assertInstanceOf(RedColorProviderInterface::class, $obj);
