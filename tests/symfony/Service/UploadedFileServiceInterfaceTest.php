 ...
 */
class UploadedFileServiceInterfaceTest extends AbstractTestCase {
    ...
    public function test__construct(): void {
        ...
        $this->assertEquals("wbw.core.service.uploaded_file", UploadedFileServiceInterface::SERVICE_NAME);
    }
}
